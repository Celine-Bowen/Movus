        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="title"> Booking Detail</h5>
              </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped m-b-none text-center" id="datatable">
                        ...
                        <tbody>
                            ...
                            {{-- @if( Auth::user()->id == $orders->customer_id ) --}}
                            @foreach ($orders as $order)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/invoice/{{ $order->order_id }}" class="btn btn-sm btn-icon btn-success"><i class="fa fa-print" ></i></a>
                                    </td>
                                </tr>

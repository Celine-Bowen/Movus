...
@section('title')
Edit-Customer Information | MOVUS 
@endsection
      ...
      <div class="col-md-8">
        <div class="card">
          <div class="card-header">
            <h5 class="title">Edit Customer Information</h5>
          </div>
          
          <form action="/customer-update/{{ $customers->customer_id }}" method="POST">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
          <div class="card-body">
              <div class="row">
              ...
              <div class="card-footer">
                <div class="modal-footer">
                    <a href="/customer-info" class="btn btn-sm btn-secondary m-2">Back</a>
        ...
        <div class="card card-user">
          ...
          <div class="card-body">
            <div class="author">
              ...
              <form enctype="multipart/form-data" action="{{ url('admin/customer-edit') }}" method="POST">

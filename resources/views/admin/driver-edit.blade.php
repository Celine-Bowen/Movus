      ...
      <div class="col-md-8">
        <div class="card">
          <div class="card-header">
            <h5 class="title">Edit Driver Information</h5>
          </div>
          
          <form action="/driver-update/{{ $drivers->driver_id }}" method="POST">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
          <div class="card-body">
              <div class="row">
              ...
              <div class="card-footer">
                <div class="modal-footer">
                    <a href="/driver-info" class="btn btn-sm btn-secondary m-2">Back</a>
        ...
        <div class="card card-user">
          ...
          <div class="card-body">
            <div class="author">
              ...
              <form enctype="multipart/form-data" action="{{ url('admin/driver-edit') }}" method="POST">
